...
const toastGenerate = document.querySelector('div[aria-atomic="true"]');
const toastDelete = document.querySelector('div[aria-atomic="false"]');
const generateToast = new bootstrap.Toast(toastGenerate);
const deleteToast = new bootstrap.Toast(toastDelete);
...
function generateData() {
  ...
  let randomUsername = Math.random().toString(36).substring(2, 6) + (randomFirstName + randomLastName).toLowerCase().replace(/[^a-z]/g, "");
